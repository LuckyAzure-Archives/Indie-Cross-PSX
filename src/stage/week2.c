...
typedef struct
{
	...
	//Textures
	Gfx_Tex tex_back0; //Background part 1
	Gfx_Tex tex_back1; //Background part 2
} Back_Week2;
...
void Back_Week2_DrawBG(StageBack *back)
{
	...
	//Draw background part 1
	RECT back_src = {0, 0, 224, 223};
	RECT_FIXED back_dst = {
		FIXED_DEC(-185,1) - fx,
		FIXED_DEC(-125,1) - fy,
		FIXED_DEC(245,1),
	...
	//Draw background part 2
	back_dst.x += back_dst.w - FIXED_DEC(1,1);
